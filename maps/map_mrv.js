...
d3.json(geoData, function(data) {
  ...
  legend.onAdd = function() {
    ...
    // Add min & max
    var legendInfo = "<h1>Mine Resistant Vehicle 1033 Transfers<br>per 10,000 residents</h1>" +
      "<div class=\"labels\">" +

// Creating map object
let myMapCH = L.map("map_combat_helmet", {
...
d3.json(geoData, function(data) {
  ...
  geojson = L.choropleth(data, {
    ...
    valueProperty: "combat_helmet_per10000",
    // Set color scale
    scale: ["#f7fbff", "#08306b"],
  ...
  legend.onAdd = function() {
    ...
    // Add min & max
    var legendInfo = "<h1>Combat Helmet 1033 Transfers<br>per 10,000 residents</h1>" +
      "<div class=\"labels\">" +

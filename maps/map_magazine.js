// Creating map object
let myMapMag = L.map("map_magazine", {
...
d3.json(geoData, function(data) {
  ...
  geojson = L.choropleth(data, {
    ...
    valueProperty: "magazine_per10000",
    // Set color scale
    scale: ["#f7fbff", "#08306b"],
  ...
  legend.onAdd = function() {
    ...
    // Add min & max
    var legendInfo = "<h1>Magazine Cartridge 1033 Transfers<br>per 10,000 residents</h1>" +
      "<div class=\"labels\">" +
